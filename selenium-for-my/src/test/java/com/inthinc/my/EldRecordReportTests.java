...
public class EldRecordReportTests {
	WebDriver driver;
	...
	@Test(priority = 1, groups = { "smokeTests", "eldRecordReport" })
	public void eldrecordreportTest(String username, String password, String expectedErrorMessage) {
		System.out.println("Starting eldRecordReport");
		...
		//click Reports
		WebElement ReportsButton = driver.findElement(By.xpath("//form[@name='j_id116']"));
		ReportsButton.click();
