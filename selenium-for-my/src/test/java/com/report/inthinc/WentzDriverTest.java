...
public class WentzDriverTest extends TenTest {

	@Test
	public void driverWentzTest() {
		System.out.println("Starting driver Wentz Test");
		// choose driver Kevin Went
		driver.findElement(By.id("hosReports_form:hosReports-groupDriverParam")).click();
		driver.findElement(By.xpath("//option[@value='77045']")).click();
		...
		// check fields Driver: Kevin Wentz
		...
		String expectedSuccessDriverMessage = "Wentz, Kevin";
		...
		String expectedSuccessIdMessage = "415664";
		...
		System.out.println("Finished driver Wentz Test");
