...
public class LuisDriverTest extends TenTest {

	@Test
	public void driverLuisTest() {
		System.out.println("Starting driver Luis Test");
		// choose driver Luis D Hernandez
		driver.findElement(By.id("hosReports_form:hosReports-groupDriverParam")).click();
		driver.findElement(By.xpath("//option[@value='113707']")).click();
		...
		String expectedLicenseStateMessage = "OK";
		...
		System.out.println("Finished driver Luis Test");
